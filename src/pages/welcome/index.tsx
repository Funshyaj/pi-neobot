...
const Welcome = () => {
    return ( <div className="flex h-screen flex-col justify-center items-center gap-10">
        <div >
          <h1 className="text-3xl lg:text-5xl font-semibold mb-10 mx-3  text-center">NeoBot <br /> AI for PI Network</h1>
        <img src={logo} alt="logo_png" className="min-h-[180px] w-[70%] md:w-2/5 lg:w-1/5 my-0 mx-auto animate-pulse"/>   
           ...
           <div className="flex flex-col items-center lg:flex-row gap-5 mx-5">
            {/* link to login page */}
            <Link to='/login'>
          <button className="button px-14 py-3 text-2xl bg-verdigris hover:bg-moonstone active:bg-moonstone">Sign In</button> 
            </Link>
            
            {/* link to login page */}
            <Link to='/login'>
          <button className="button px-14 py-3 text-2xl bg-cerulean hover:bg-ceruleanD active:bg-ceruleanD">Sign up</button>
            </Link>
   </div>
